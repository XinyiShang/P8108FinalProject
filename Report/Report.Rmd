...
cox_summary_b |>
  ...
  kable_styling(full_width = FALSE)
```
In Table \ref{tab:edemaStrataCox}, we see the hazard ratios, 95% confidence interval, and p-values for the model after stratifcation of edema. 
...
We can see from Figure \ref{fig:PHStrataEdemaPlots} that there are slight improvments to the covariates that were initially were violations. 
